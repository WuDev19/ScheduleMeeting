...
const accounts = [
  ...
  { username: 'kduy', password: 'Aa123456@', pos: { x: 630, y: 0 } },
  { username: 'vantoi', password: 'Aa123456@', pos: { x: 1260, y: 0 } }
];
...
async function run() {
  ...
  console.log('Đang khởi chạy 3 trình duyệt song song...');

  const instances = [];

  try {
    // 1. Launch 3 separate browser instances to position them side-by-side
    ...
    console.log('\n=================== SẴN SÀNG ===================');
    console.log('1. Vui lòng thao tác trên cả 3 màn hình trình duyệt để mở modal đăng ký đặt lịch.');
    ...
    console.log('5. Sau khi nhập xong ở cả 3 bên, quay lại cửa sổ terminal này.');
    console.log('==================================================\n');
    ...
    await askQuestion('==> Nhấn phím ENTER để thực hiện CLICK nút submit đồng thời trên cả 3 trình duyệt...');

    console.log('\nĐang gửi lệnh click đồng thời ở cả 3 cửa sổ...');
    ...
    console.log('Vui lòng kiểm tra phản hồi trên 3 cửa sổ trình duyệt (xem Toast message báo lỗi hoặc thành công).');
